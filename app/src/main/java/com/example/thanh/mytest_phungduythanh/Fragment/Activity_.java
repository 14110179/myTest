...
import com.example.thanh.mytest_phungduythanh.Adapter.CustomAdapter5;
 ...
 */
public class Activity_ extends Fragment {
    ...
    private CustomAdapter5 customAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        duLieudatas();
        listView=(ListView)v.findViewById(R.id.listActivity);
        customAdapter=new CustomAdapter5(getContext(),datas);
